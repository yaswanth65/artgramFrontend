...
const Navbar = () => {
  ...
  const linkBase =
    "text-slate-900 hover:text-rose-600 transition-colors px-3 py-2 rounded-md text-xl font-semibold";
  const activeLink = "text-rose-600 font-bold";
  ...
  return (
    <nav
      id="universalNavbar"
      className="fixed top-0 inset-x-0 z-[1030] bg-white shadow-sm"
    >
      <div className="mx-auto max-w-7xl px-4">
        <div className="flex items-center justify-between h-[104px]">
          <div className="flex items-center gap-4">
            ...
            >
              <img
                src="https://res.cloudinary.com/df2mieky2/image/upload/v1754901865/ARTGRAM_LOGO-removebg-preview_o9oxti.png"
                alt="ArtGram Logo"
