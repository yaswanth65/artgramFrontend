...
export default function SlimePlayPage() {
  ...
  const [timeSlots, setTimeSlots] = useState([
    { time: '10:00', label: '10:00 AM', status: 'available', type: 'Slime Play & Demo', age: '3+ years', available: 12, total: 15 },
    { time: '11:30', label: '11:30 AM', status: 'available', type: 'Slime Play & Making', age: '8+ years', available: 8, total: 15 },
    { time: '1:00', label: '1:00 PM', status: 'filling-fast', type: 'Slime Play & Demo', age: '3+ years', available: 4, total: 15 },
    { time: '2:30', label: '2:30 PM', status: 'available', type: 'Slime Play & Demo', age: '3+ years', available: 15, total: 15 },
    { time: '4:00', label: '4:00 PM', status: 'filling-fast', type: 'Slime Play & Making', age: '8+ years', available: 3, total: 15 },
    { time: '5:30', label: '5:30 PM', status: 'sold-out', type: 'Slime Play & Demo', age: '3+ years', available: 0, total: 15 }
  ]);
  ...
  const getLocationName = (location) => {
    const locationNames = { downtown: 'Vijayawada', mall: 'Hyderabad', park: 'Bangalore' }
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-100 to-purple-100">
      ...
      <section className="relative h-[70vh] bg-black flex items-center justify-center text-center text-white overflow-hidden">
        ...
        <div className="relative z-20 max-w-4xl px-5">
          ...
          <p className="text-2xl mb-8 drop-shadow-md">1 Hr & 1 Hr 15 min sessions</p>
          <a href="#booking" className="inline-block bg-gradient-to-r from-yellow-400 to-orange-500 text-white px-10 py-4 rounded-full font-bold text-xl transition-all duration-300 hover:scale-105 hover:shadow-2xl animate-pulse">
        ...
        <div className="max-w-6xl mx-auto px-5">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white rounded-2xl p-8 border-l-4 border-green-400">
              ...
              <p className="text-gray-700">By booking only, Limited slots. Advance booking essential to secure your spot for this popular experience.</p>
            </div>
            <div className="bg-white rounded-2xl p-8 border-l-4 border-green-400">
              <h4 className="text-xl font-bold text-red-600 mb-3">Parent Supervision</h4>
              <p className="text-gray-700">One parent allowed with 1 kid (below 12yrs). We ensure a safe and supervised environment for all activities.</p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 border-l-4 border-green-400">
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-2">
                  <li>For <strong>Slime Play & Demo</strong> sessions: anyone above <strong>3+ years</strong> is welcome.</li>
                  <li>For <strong>Slime Play & Making</strong> sessions: anyone above <strong>8+ years</strong> is welcome.</li>
              </ul>
            </div>
            {/* Group Session point added */}
            <div className="bg-white rounded-2xl p-8 border-l-4 border-green-400">
              <h4 className="text-xl font-bold text-red-600 mb-3">Group & Private Sessions</h4>
              <p className="text-gray-700">All our Slime sessions are group sessions. Private sessions are available for an additional cost. Please contact us for details.</p>
            </div>
          </div>
        </div>
      </section>
              ...
              <div>
                ...
                <div className="flex gap-4 flex-wrap justify-center mb-5">
                  {[...Array(7)].map((_, i) => {
                    ...
                    return (
                        <div key={value} onClick={() => selectDate(value)} className={`border-2 rounded-lg p-4 text-center cursor-pointer transition-all min-w-24 ${bookingData.date === value ? 'border-green-400 bg-green-100 -translate-y-1 shadow-lg' : 'border-gray-200 hover:border-green-400 hover:bg-green-50'}`}>
