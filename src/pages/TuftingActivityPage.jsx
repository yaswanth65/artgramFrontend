    ...
    <div>
      ...
      <header className="relative text-white text-center py-28 bg-gradient-to-tr from-purple-600 to-pink-600 overflow-hidden">
        <div className="relative z-10 max-w-3xl mx-auto px-6">
          <h1 className="text-4xl md:text-5xl font-black mb-6 drop-shadow">🧶 INDIA'S PREMIER TUFTING STUDIO 🧶</h1>
          <a
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-secondary mb-10">🤔 What is Tufting?</h2>
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <img src="https://images.unsplash.com/photo-1608500218965-0c2c0596026a?auto=format&fit=crop&w=800&q=80" alt="Tufting" className="rounded-xl" />
            </div>
            <div className="flex flex-col justify-center space-y-6">
              <div className="p-4 bg-white rounded-xl shadow-md">
                <div className="text-3xl mb-2">🎨</div>
                <h3 className="text-xl font-bold mb-2">Creative Expression</h3>
                <p>Design your own patterns, choose from premium yarns, and bring your artistic vision to life through the ancient art of tufting.</p>
              </div>
              <div className="p-4 bg-white rounded-xl shadow-md">
                <div className="text-3xl mb-2">🧘‍♀️</div>
                <h3 className="text-xl font-bold mb-2">Mindful Crafting</h3>
                <p>Experience the meditative rhythm of tufting. Perfect for stress relief, focus building, and mindful creativity.</p>
              </div>
              <div className="p-4 bg-white rounded-xl shadow-md">
                <div className="text-3xl mb-2">🏠</div>
                <h3 className="text-xl font-bold mb-2">Take Home Masterpieces</h3>
                <p>Create functional art! Every session produces beautiful rugs, coasters, wall hangings, or decorative pieces you'll treasure forever.</p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-pink-50">
        <div className="mx-auto max-w-6xl px-4">
          <h2 className="text-3xl font-bold text-center mb-10">🖼️ Tufting Gallery - Student Creations</h2>
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
            {[
              "https://res.cloudinary.com/df2mieky2/image/upload/v1754651196/DSC07703_y0ykmy.jpg",
              "https://res.cloudinary.com/df2mieky2/image/upload/v1754651200/HAR05892_zs7cre.jpg",
              "https://res.cloudinary.com/df2mieky2/image/upload/v1754651194/IMG_0168_kqn6hv.jpg",
              "https://res.cloudinary.com/df2mieky2/image/upload/v1754651192/HAR05922_vmmr5p.jpg",
              ...
              <div key={src} className="rounded-xl overflow-hidden shadow">
                <img src={src || "/placeholder.svg"} alt="Tufting creation" className="w-full h-[250px] object-cover" />
              </div>
            ))}
          </div>
        </div>
                ...
                {sessions.map((s) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="text-sm opacity-80">02 - 04 Hr (Depending on Size)</div>
                      <div className={`mt-2 font-bold ${selected ? "text-white" : "text-red-600"}`}>₹ {s.price}</div>
                    </div>
                  )
                })}
              </div>
            ...
            >
              ...
              {booking.quantity && booking.session && (
                ...
                >
                  ...
                  <div className="mt-3 text-center font-extrabold text-xl">Total Amount: ₹{total.toLocaleString()}</div>
                  <button
